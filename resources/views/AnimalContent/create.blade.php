<x-app-layout title="Cards">
    <!-- Include Animal Icons CSS -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/animal-icons/css/animal-icons.css" integrity="sha384-rH5LNM5MlHRCE+q9WA5ItDSHzI65pZLlhoEehI4nFvs+3KT1Ei6Vc9Bbyh2DIdzA" crossorigin="anonymous">
            ...
            <fieldset>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        <label for="name" class="dark:text-gray-200 text-gray-700">Identification<span class="text-red-900">*</span></label>
                    ...
                    <!-- Species -->
                    <div class="relative">
                        <label for="animal_type" class="text-gray-700 dark:text-gray-200">Species<span class="text-red-900">*</span></label>
                        <div class="relative">
                    ...
                    <!-- Breed -->
                    <div class="flex flex-col">
                        <label for="animal_breed" class="text-gray-700 dark:text-gray-200">Breed<span class="text-red-900">*</span></label>
                    ...
                    <!-- Gender -->
                    <div class="flex flex-col">
                        <label for="animal_gender" class="text-gray-700 dark:text-gray-200">Gender<span class="text-red-900">*</span></label>
                    ...
                    <!-- Labels/Keywords -->
                    <div class="flex flex-col">
                        <label for="animal_keywords" class="text-gray-700 dark:text-gray-200">Labels/Keywords<span class="text-red-900">*</span></label>
                        <input type="text" name="keywords_{{ auth()->user()->id }}" name="keywords" id="animal_keywords" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700" placeholder="Calf, Steer, Dairy, Stud, Fiber, Broiler, etc" required>
                    </div>

                    <!-- Reference Number -->
                    <div class="flex flex-col">
                        <label for="animal_internal_id" class="text-gray-700 dark:text-gray-200">Reference Number</label>
                        <input type="text" name="internal_id" id="animal_internal_id" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700" placeholder="The Reference Number will be generated automatically" disabled>
                    </div>

                    <!-- Status -->
                    <div class="flex font-serif flex-col">
                        <label for="animal_status" class="text-gray-700 font-serif dark:text-gray-200">Status<span class="text-red-900">*</span></label>
                        <!-- ... (other code) ... -->
                        <select name="status" id="animal_status" class="border font-serif rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700" required>
                            ...
                            <option value="In Reproduction">In Reproduction</option>
                            <option value="In Transit">In Transit</option>
                            <option value="Awaiting Adoption">Awaiting Adoption</option>
            ...
            <div class="container mx-auto mt-8 p-4 font-serif  shadow-md bg-white dark:bg-gray-700 dark:shadow-md">
                    ...
                    <fieldset>
                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <!-- Weight -->
                            <div class="flex flex-col">
                                <label for="animal_weight" class="dark:text-gray-200 text-gray-700">Weight (kg)<span class="text-red-900">*</span></label>
                                <input type="number"  step="0.01" max="100000" name="weight" id="animal_weight" placeholder="Enter weight in kg" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700" required>
                            </div>
...
{{--Identification--}}
            <div class="container font-serif mx-auto mt-8 p-4 shadow-md bg-white dark:bg-gray-700 dark:shadow-md">
...
{{--Birth Information--}}
            <div class="container font-serif mx-auto mt-8 p-4  mb-4 shadow-md bg-white dark:bg-gray-700 dark:shadow-md">
                    ...
                    <fieldset>
                        ...
                        <div class="mt-4">
                            <label class="block text-sm font-medium text-gray-700 dark:text-white">Raised or Purchased<span class="text-red-900">*</span></label>
                            <div class="flex">
                                <div class="mr-4">
                                    <input class="form-radio" type="radio" name="raised_purchased" value="Raised" id="raisedRadio" required>
                                    <label class="ml-2" for="raisedRadio">Raised</label>
                                </div>
                                <div>
                                    <input class="form-radio" type="radio" name="raised_purchased" value="Purchased" id="purchasedRadio" required>
...
{{--
    ...
    <script>
        ...
        animalTypeList.forEach(animal => {
            ...
            // Create an img element with the animal icon
            const icon = document.createElement("img");
            icon.src = `https://cdn.jsdelivr.net/npm/animal-icons/icons/svg/${animal.toLowerCase()}.svg`;
            icon.alt = animal;
