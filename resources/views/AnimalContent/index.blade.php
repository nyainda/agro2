...
<nav class="flex flex-wrap justify-between px-4 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
    ...
    <header class="bg-gray-800 text-white py-4 text-center">
        <h1 class="text-4xl font-extrabold">Farm Dashboard</h1>
      </header>

      <div class="container dark:text-gray-200 font-serif dark:bg-gray-700 mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">

        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 flex flex-col items-center justify-center">
            <h2 class="text-2xl font-bold text-green-500 mb-4">Total Animals on Feeding</h2>
            <p class="text-5xl font-extrabold text-green-500">{{ $totalAnimalsFeeding }}</p>
          </div>

          <div class="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 flex flex-col items-center justify-center">
            <h2 class="text-2xl font-bold text-blue-500 mb-4">Vaccination of Animals</h2>
            <ul class="list-none pl-4 text-center flex flex-col space-y-2">
              <li>
                <a href="{{ route('animals.show', ['status' => 'partially_vaccinated']) }}" class="hover:text-blue-700 transition-colors duration-300">
                  Partially Vaccinated: <span class="font-bold">{{ $partiallyVaccinatedCount }}</span>
                </a>
              </li>
              <li>
                <a href="{{ route('animals.show', ['status' => 'fully_vaccinated']) }}" class="hover:text-blue-700 transition-colors duration-300">
                  Fully Vaccinated: <span class="font-bold">{{ $fullyVaccinatedCount }}</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 flex flex-col items-center justify-center">
          <h2 class="text-2xl font-bold text-red-500 mb-4">Health Status</h2>
          <p class="text-5xl font-extrabold">Good</p>
        </div>
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h2 class="text-xl font-bold mb-4">Animal Health</h2>
            <p>Healthy: <span class="font-semibold text-green-600">220</span></p>
            <p>Sick: <span class="font-semibold text-red-600">20</span></p>
            <p>Recovering: <span class="font-semibold text-yellow-600">10</span></p>
            <a href="#" class="mt-4 inline-block bg-gradient text-white py-2 px-4 rounded-lg hover:bg-teal-600">View Details</a>
        </div>

        <div class="bg-white rounded-lg shadow-lg p-6">
            <h2 class="text-xl font-bold mb-4">Feeding and Nutrition</h2>
            <p>Feed Inventory: <span class="font-semibold">5,000 kg</span></p>
            <p>Daily Consumption: <span class="font-semibold">1,200 kg</span></p>
            <a href="#" class="mt-4 inline-block bg-gradient text-white py-2 px-4 rounded-lg hover:bg-teal-600">View Schedules</a>
        </div>

        <div class="bg-white rounded-lg shadow-lg p-6">
            <h2 class="text-xl font-bold mb-4">Farm Overview</h2>
            <p>Total Animals: <span class="font-semibold">250</span></p>
            <p>Cows: <span class="font-semibold">120</span></p>
            <p>Pigs: <span class="font-semibold">80</span></p>
            <p>Chickens: <span class="font-semibold">50</span></p>
        </div>
