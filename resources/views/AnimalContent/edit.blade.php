                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="type" id="animal_type" value="{{$animal ->type }}" name="name_{{ auth()->user()->id }}" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 w-full dark:text-gray-200 dark:bg-gray-700"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="name_{{ auth()->user()->id }}" name="breed" id="animal_breed"  class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700" value="{{$animal->breed}}">
                    </div>

                    <!-- Gender -->
                    <div class="flex flex-col">
                        <label for="animal_gender" class="text-gray-700 dark:text-gray-200">Gender</label>
                        <select name="gender" name="name_{{ auth()->user()->id }}"  id="animal_gender" value="{{$animal->gender }}" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="name_{{ auth()->user()->id }}"  name="keywords" id="animal_keywords" value="{{$animal ->keywords }}" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700" placeholder="Calf, Steer, Dairy, Stud, Fiber, Broiler, etc">
                    </div>

                    <!-- Reference Number -->
                    <div class="flex flex-col">
                        <label for="animal_internal_id" class="text-gray-700 dark:text-gray-200">Reference Number</label>
                        <input type="text" name="name_{{ auth()->user()->id }}"  name="internal_id" id="animal_internal_id" value="{{$animal ->internal_id }}" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700" placeholder="Example: A001" disabled>
                    </div>

                    <!-- Status -->
                    <div class="flex flex-col">
                        <label for="animal_status" class="text-gray-700 font-serif dark:text-gray-200">Status</label>
                        <select name="name_{{ auth()->user()->id }}" name="status" id="animal_status" value="{{$animal ->status }}" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700">
                    ...
                    <div id="dateDeceasedSection" class="mt-6" style="display: none;">
                        <div class="flex flex-col">
                            ...
                            <input type="date" name="name_{{ auth()->user()->id }}" name="death_date" id="animal_death_date" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:bg-gray-800">
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea rows="4" name="name_{{ auth()->user()->id }}" name="deceased_reason" id="animal_deceased_reason" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write the reason for deceased..."></textarea>
                        </div>
                    </div>
            </fieldset>
        </div>
            <div class="container mx-auto mt-8 p-4 bg-white shadow-md dark:bg-gray-700 dark:shadow-md">
                    ...
                    <fieldset>
                        ...
                        <div class="grid grid-cols-1 mt-4 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" name="name_{{ auth()->user()->id }}" placeholder="Brown, white, Black, etc" value="{{$animal ->coloring}}" name="coloring" id="animal_coloring" class="border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-400 dark:text-gray-200 dark:bg-gray-700">
                            </div>
        ...
        <div class="container mx-auto mt-8 p-4 mb-4 shadow-md bg-white dark:bg-gray-700 dark:shadow-md">
            ...
            <fieldset>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex">
                        <div class="mr-4">
                            <input class="form-radio" type="radio" name="raised_purchased" value="{{$animal->raised_purchased}}" id="raisedRadio">
                            <label class="ml-2" for="raisedRadio">Raised</label>
                        </div>
                        <div>
                            <input class="form-radio" type="radio" name="raised_purchased" value="{{$animal->raised_purchased}}" id="purchasedRadio">
                    ...
                    <div id="purchasedForm" class="mt-4" style="display: none;">
                        <h3 class="text-lg font-semibold text-gray-700 dark:text-white">Purchased Animal Details</h3>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-input dark:bg-gray-700 dark:text-gray-200 w-full " value="{{$animal->purchaseDate}}" id="purchaseDate" name="purchaseDate">
                            </div>
                            <div class="mb-4">
                                <label for="purchasePrice" class="block text-sm font-medium text-gray-700 dark:text-white">Purchase Price</label>
                                <input type="number" class="form-input dark:bg-gray-700 dark:text-gray-200 w-full " value="{{$animal->purchasePrice}}" id="purchasePrice" name="purchasePrice" placeholder="Enter purchase price">
                            </div>
                            <div class="mb-4">
                                <label for="vendor" class="block text-sm font-medium text-gray-700 dark:text-white">Vendor Name</label>
                                <input type="text" class="form-input dark:bg-gray-700 dark:text-gray-200 w-full" id="vendor" value="{{$animal->vendor}}" name="vendor" placeholder="Enter vendor name">
                            </div>
                            <div class="mb-4">
                        ...
                        <option value="Other Procedure">Other Procedure</option></select>
                            ...
                            <div class="mb-4">
                                ...
                                <select id="deficts" value="{{$animal->deficts}}" name="deficts" class="form-select  dark:bg-gray-700 dark:text-gray-200 w-full">
                                    <option value="Healthy ">Healthy</option>
                                    <option value="Sick">Sick</option>
                                </select>
                            </div>
