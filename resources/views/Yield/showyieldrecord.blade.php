    ...
    <div class="container mx-auto p-6 space-y-6 font-serif">
        ...
        <div class="mb-4 flex flex-col font-serif sm:flex-row justify-between items-center">
            <div class="mb-2 sm:mb-0">
                <a class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition duration-300 ease-in-out" data-remote="true" href="{{ route('Yield.yieldrecord', ['animal_id' => $animal->id]) }}">New Yield Record</a>
            </div>
            <div class="sm:ml-2">
        ...
        <div class="mb-4">
            <button type="button" onclick="batchDelete()" class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-md shadow-md transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50">Delete Selected</button>
        </div>
