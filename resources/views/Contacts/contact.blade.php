...
<x-app-layout title="Contact">
    ...
    <div class="container mx-auto mt-8 p-4 mb-8 bg-white dark:bg-gray-700 dark:rounded-lg dark:shadow-lg">
            <div class="col-span-full">
                <h3 class="text-xl mb-4 font-serif dark:text-gray-200 font-semibold">Contact Field</h3>
            </div>
            <hr class="col-span-full mb-4">
            <form action="{{ route('Contacts.storecontact', ['animal_id' => $animal->id]) }}" method="POST">

                @csrf
            <div class="grid grid-cols-1 font-serif md:grid-cols-2 gap-4">
                <div class="col-span-1 ">
                    <label for="contact_first_name" class="dark:text-gray-200  mt-2">First name<span class="text-red-800">*</span></label>
                    <input class="w-full border dark:bg-gray-800 dark:text-gray-200 mb-2 border-gray-300 rounded-md p-2 focus:outline-none focus:ring focus:ring-blue-300" type="text"  name="first_name" id="contact_first_name" autocomplete="off" required>
                </div>
                <div class="col-span-1">
                    <label for="contact_last_name" class="dark:text-gray-200 mb-4 mt-2">Last name<span class="text-red-800">*</span></label>
                    <input class="w-full border dark:bg-gray-800 dark:text-gray-200 border-gray-300 rounded-md p-2 focus:outline-none focus:ring focus:ring-blue-300"
                           type="text"
                           name="last_name_{{ auth()->user()->id }}"
                           id="name_{{ auth()->user()->id }}"
                           required>
                </div>
            ...
            <div class="grid grid-cols-1 font-serif md:grid-cols-2 gap-4">
                <div class="col-span-1">
                    <label for="contact_first_name" class="dark:text-gray-200 mb-4 mt-2">Email<span class="text-red-800">*</span></label>
                    <input class="w-full border dark:bg-gray-800 dark:text-gray-200 border-gray-300 rounded-md p-2 focus:outline-none focus:ring focus:ring-blue-300" type="text"   name="email" id="last_name" required>
                </div>
    ...
    <option value="Zimbabwe">Zimbabwe</option>
            ...
            <div class="col-span-1">
                <div class="col-span-1">
                    <label for="treatment_type" class="block mb-1 dark:text-gray-100 font-serif font-medium dark:bg-gray-700 text-gray-700">Contact type[eg.vet]<span class="text-red-800 lg">*</span></label>
