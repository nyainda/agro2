<x-app-layout title="Forms">
    <div class="container mx-auto mt-8 p-4 mb-4 dark:bg-gray-700 dark:rounded-lg font-serif bg-gray-20 rounded-lg shadow-lg">
        <div class="modal-header mb-4 flex justify-between items-center">
            <h3 class="text-2xl dark:text-gray-200 font-serif text-gray-800 font-semibold">New Treatment</h3>
        </div
            ...
            <form action="{{ route('treat.storetreament', ['animal_id' => $animal->id]) }}"  method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div class="col-span-1">
                        <label class="block text-sm dark:text-gray-100 font-medium text-gray-700">Veterinarian Contact</label>
                        <div class="mt-1">
                            <p class="text-gray-500 dark:text-gray-200 mt-2">
                                You can <a href="{{ route('Contacts.contact', ['animal_id' => $animal->id]) }}" class="text-blue-500">register a new vet</a>.
                            </p>
                        </div>
                    </div>
                    <div class="col-span-1">
