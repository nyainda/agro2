<x-app-layout title="Cards">
    ...
    <div class="container mx-auto mt-8 p-4 font-serif dark:bg-gray-700 dark:shadow-md">
        <form action="{{ route('Sale.storebill', ['animal_id' => $animal->id]) }}" method="POST" class="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
            @csrf
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="sold_to" id="sold_to" class="mt-1 dark:bg-gray-700 dark:text-gray-200 p-3 w-full rounded-md border border-gray-300 focus:ring focus:ring-blue-200" placeholder="E.g:bruce oyugi">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div class="col-span-1">
                            ...
                            <div class="flex items-center mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="sale_price" id="sale_price" value="0" max="100000" class="pl-7 pr-3 dark:bg-gray-700 dark:text-gray-200 p-3 w-full rounded-md border border-gray-300 focus:ring focus:ring-blue-200">
                            </div>
                        </div>
                    </div>
